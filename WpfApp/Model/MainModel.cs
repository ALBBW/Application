...
namespace WpfApp.Model
{
	public class MainModel
	{
		...
		string eatingplanjsonread = "";
		string eatingplanjsonwrite = "";
		...
		char meetingsign = '*';
		public enum TransmissionReason { ReceiveCalendarData, ReceiveAccountData, ReceiveEatingPlanData }
			...
			public JSONHeader(byte[] ipv4, short port, TransmissionReason reason)
			{
				...
				switch (reason)
				{
					...
					case TransmissionReason.ReceiveCalendarData:
						...
						break;
					case TransmissionReason.ReceiveEatingPlanData:
						this.reason = "ReceiveEatingPlanData";
						break;
				}
			}
		}
		...
		{
			public string EatingItemDate { get; set; }
			public string EatingItemDescription { get; set; }

			public EatingItem(string date, string description)
			{
				EatingItemDate = date;
				EatingItemDescription = description;
			}
		}

		public class EatingItemList
		{
			public System.Collections.ObjectModel.ObservableCollection<EatingItem> EatingItems { get; set; }

			public EatingItemList(System.Collections.ObjectModel.ObservableCollection<EatingItem> list)
			{
				EatingItems = list;
			}
		}
		...
		public string GetWriteEatingPlanJSON()
		{
			return datajsonwrite;
		}
		...
		{
			return eatingplanjsonread.Clone();
		}

		public object GetWriteEatingPlanJSONObject()
		{
			return eatingplanjsonwrite.Clone();
		}

		public void SetReadEatingPlanJSON(string eatingplanjson)
		{
			eatingplanjsonread = eatingplanjson;
		}

		public void SetWriteEatingPlanJSON(string eatingplanjson)
		{
			eatingplanjsonwrite = eatingplanjson;
		}
